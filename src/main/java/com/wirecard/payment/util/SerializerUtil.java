package com.wirecard.payment.util;
...
public class SerializerUtil {
    ...
    public Map<String, String> parseResponse(String body) throws IOException {
        Map<String, String> payload = new HashMap<>();
        L.info(body);
        if(body.endsWith("</html>")) {
            throw new IOException("Wrong response type from remote server");
        }
